      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 max-w-xs text-sm text-muted-foreground">
            An AI-powered public grievance platform empowering citizens and government to report,
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-destructive" /> Police — 100
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-destructive" /> Ambulance — 108
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-destructive" /> Fire — 101
            </li>
            <li className="flex items-center gap-2">
              <Phone className="h-4 w-4 text-destructive" /> Women Helpline — 181
            </li>
          </ul>
        </div>
      </div>
